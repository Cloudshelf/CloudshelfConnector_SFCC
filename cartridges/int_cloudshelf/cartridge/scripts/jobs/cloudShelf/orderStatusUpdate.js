...
module.exports.execute = function () {
    ...
    OrderMgr.processOrders(processOrder, "status!={0} and paymentStatus={1} and custom.isCloudshelf={2} and custom.cloudshelfStatus!={3}", Order.ORDER_STATUS_CANCELLED, Order.PAYMENT_STATUS_PAID, true, CLOUDSHELF_ORDER_STATUSES.PAID);

    Logger.info("Processing Cloudshelf orders with status Cancelled");
    OrderMgr.processOrders(processOrder, "status={0} and custom.isCloudshelf={1} and custom.cloudshelfStatus!={2}", Order.ORDER_STATUS_CANCELLED, true, CLOUDSHELF_ORDER_STATUSES.VOIDED);
