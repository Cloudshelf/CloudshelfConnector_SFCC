...
Cartridge is compatible with 6.3.0 SFRA version and Salesforce Commerce
...
-   Account and API key created on Cloudshlef side - [Getting Started](https://documentation.cloudshelf.ai/getting-started/welcome)
...
To export stores from SFCC to Cloudshlef as location go to **BM > Merchant Tools > Online Marketing > Stores > [select store] > CLOUDSHELF Tab**, set isCloudShelf to be "Yes" and click "Save"
...
Transferring basket from Cloudshlef to SFCC functionality works using
